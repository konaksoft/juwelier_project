...
var KTTablesWidget16 = function () {
    var e = {self: null, rendered: !1}, t = {self: null, rendered: !1}, a = {self: null, rendered: !1},
        ...
        h = {self: null, rendered: !1}, p = {self: null, rendered: !1}, y = {self: null, rendered: !1},
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        h.mapPolygons.template.setAll({
                            tooltipText: "{name}",
                            interactive: !0
                        }), h.mapPolygons.template.states.create("hover", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), h.mapPolygons.template.states.create("active", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), h.mapPolygons.template.events.on("click", (function (e) {
    ...
    var e = {self: null, rendered: !1}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"),
                ...
                s = KTUtil.getCssVariableValue("--bs-success"), n = {
                    series: [{
                        name: "Inbound Calls",
...
var KTChartsWidget47 = function () {
    var e = {self: null, rendered: !1}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-white"), r = {
                series: [{
                    name: "Sales",
                ...
                fill: {
                    type: "gradient",
                    gradient: {shadeIntensity: 1, opacityFrom: .5, opacityTo: 0, stops: [0, 80, 100]}
                },
...
var KTChartsWidget48 = function () {
    var e = {self: null, rendered: !1}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-danger"), r = {
                series: [{
                    name: "Sales",
                    data: [5, 5, 15, 15, 19, 16, 27, 24, 34, 25, 40, 30, 19, 17, 22, 10, 14, 14]
                }],
                ...
                fill: {
                    type: "gradient",
                    gradient: {shadeIntensity: 1, opacityFrom: .5, opacityTo: 0, stops: [0, 120, 50]}
                },
                stroke: {curve: "smooth", show: !0, width: 2, colors: [l]},
                xaxis: {
                    axisBorder: {show: !1},
